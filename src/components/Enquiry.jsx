    ...
    return (
        <div className="font-satoshi flex flex-col items-center justify-center">
            ...
            <div className="flex flex-row sm:flex-col-reverse items-center justify-center space-x-5 sm:space-x-0 gap-3 mt-10">
                <a href="https://twitter.com/base_arena" target="blank" className="flex flex-row items-center justify-center space-x-2 border border-gray-400 text-gray-950 font-medium rounded px-9 py-2 cursor-pointer">
                    <BsTwitter className='text-gray-500' />
                    <span className="text-[0.9rem]"> Twitter </span>
                </a>
                <a href="https://www.instagram.com/mabweddings_/" target="blank"  className="flex flex-row items-center justify-center space-x-2 border border-gray-400 text-gray-950 font-medium rounded px-9 py-2 cursor-pointer">
