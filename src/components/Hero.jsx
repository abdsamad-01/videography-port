...
const Hero = () => {
    return (
        <div className="flex flex-row md:flex-col w-full md:px-5 sm:px-3 md:pt-28 items-center justify-between pl-20 llg:pl-9 md:pl-0 overflow-hidden">
            <div className="w-[87%] md:w-full">
                <div className='md:px-4 sm:px-1'>
                    ...
                    />
                    <h1 className="font-satoshi font-bold text-7xl llg:text-6xl sm:text-5xl"> Let's Document Your Incredible <span className='text-secondary'> Moments </span></h1>
